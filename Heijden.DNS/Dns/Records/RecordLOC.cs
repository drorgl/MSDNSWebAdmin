...
namespace Heijden.DNS
{
    /// <summary>
    /// LOC - Location record
    /// <para>Specifies a geographical location associated with a domain name</para>
    /// <para>http://tools.ietf.org/html/rfc1876</para>
    /// </summary>
	public class RecordLOC : Record
	{
		...
		private string SizeToString(byte s)
		{
			...
			*/
            ...
            sb.AppendFormat(CultureInfo.InvariantCulture, "{0}", intBase);
			for (; intPow > 0; intPow--)
				sb.Append('0');
			sb.Append(strUnit);
			return sb.ToString();
