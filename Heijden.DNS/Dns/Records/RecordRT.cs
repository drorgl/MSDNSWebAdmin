...
namespace Heijden.DNS
{
	...
	{
        /// <summary>
        ///  preference of the route.  Smaller numbers indicate more preferred routes.
        /// </summary>
        public ushort PREFERENCE { get; set; }
        /// <summary>
        /// intermediate-host is the domain name of a host which will serve as an 
        /// intermediate in reaching the host specified by owner.
        /// </summary>
